...
class DatabaseScanner(BaseScanner):
    ...
    def scan(self) -> List[Dict[str, Any]]:
        ...
        for db_config in self.config['sources']:
            ...
            try:
                # Connect to database
                connection_string = self._create_connection_string(db_type, host, port, username, password, database)
    ...
    def _create_connection_string(self, db_type: str, host: str, port: int, username: str, password: str, database: str) -> str:
        ...
        try:
            ...
            for table in tables:
                ...
                for column in columns:
                    # Check column data
                    sample_data = self._get_column_sample(connection_string, table, column)
                    ...
                    # Store result
                    self._save_audit_record(table, column, data_type, sensitivity, sample_data)
    ...
    def _get_column_sample(self, connection_string: str, table: str, column: str) -> str:
    ...
    def _save_audit_record(self, table: str, column: str, data_type: str, sensitivity: str, sample_data: str):
        """Save audit record"""
        record = {
